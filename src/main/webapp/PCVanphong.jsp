    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="product">
                    <div class="product-img">
                        <img src="./img/pcvanphong1.png" alt="Office PC 1">
                    </div>
                    <div class="product-body">
                        <h3 class="product-name">Office PC 1</h3>
                        <h4 class="product-price">$799.00</h4>
                        <p><strong>Cấu hình:</strong> Intel Core i5, 8GB RAM, 256GB SSD, Integrated Graphics</p>
            ...
            <div class="col-md-3">
                <div class="product">
                    <div class="product-img">
                        <img src="./img/pcvanphong2.png" alt="Office PC 2">
                    </div>
                    <div class="product-body">
                        <h3 class="product-name">Office PC 2</h3>
                        <h4 class="product-price">$899.00</h4>
                        <p><strong>Cấu hình:</strong> Intel Core i7, 16GB RAM, 512GB SSD, Integrated Graphics</p>
            ...
            <div class="col-md-3">
                <div class="product">
                    <div class="product-img">
                        <img src="./img/pcvanphong1.png" alt="Office PC 3">
                    </div>
                    <div class="product-body">
                        <h3 class="product-name">Office PC 3</h3>
                        <h4 class="product-price">$749.00</h4>
                        <p><strong>Cấu hình:</strong> AMD Ryzen 5, 8GB RAM, 256GB SSD, Integrated Graphics</p>
            ...
            <div class="col-md-3">
                <div class="product">
                    <div class="product-img">
                        <img src="./img/pcvanphong2.png" alt="Office PC 4">
                    </div>
                    <div class="product-body">
                        <h3 class="product-name">Office PC 4</h3>
                        <h4 class="product-price">$849.00</h4>
                        <p><strong>Cấu hình:</strong> AMD Ryzen 7, 16GB RAM, 512GB SSD, Integrated Graphics</p>
            ...
            <div class="col-md-3">
                <div class="product">
                    <div class="product-img">
                        <img src="./img/pcvanphong1.png" alt="Office PC 4">
                    </div>
                    <div class="product-body">
                        <h3 class="product-name">Office PC 4</h3>
                        <h4 class="product-price">$849.00</h4>
            ...
            <div class="col-md-3">
                <div class="product">
                    <div class="product-img">
                        <img src="./img/pcvanphong2.png" alt="Office PC 5">
                    </div>
                    <div class="product-body">
                        <h3 class="product-name">Office PC 5</h3>
                        <h4 class="product-price">$929.00</h4>
                        <p><strong>Cấu hình:</strong> Intel Core i5, 16GB RAM, 1TB HDD, Integrated Graphics</p>
